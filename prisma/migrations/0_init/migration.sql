...
-- CreateEnum
CREATE TYPE "TareaEstado" AS ENUM ('pendiente', 'en_progreso', 'completado', 'cancelado');

-- CreateEnum
CREATE TYPE "TareaAsignacionEstado" AS ENUM ('pendiente', 'en_progreso', 'completado', 'cancelado');
...
CREATE TABLE "capacitacion_asistente" (
    ...
    CONSTRAINT "capacitacion_asistente_pkey" PRIMARY KEY ("evento_capacitacion_id","user_id")
);
...
CREATE TABLE "evento_accidente" (
    ...
    "fecha" DATE NOT NULL,
    "bodega_id" UUID,
    "accidentado_user_id" UUID NOT NULL,
    "tipo" TEXT,
...
CREATE TABLE "evento_entrega_epp" (
    ...
    "fecha" DATE NOT NULL,
    "bodega_id" UUID,
    "receptor_user_id" UUID NOT NULL,
    "epp" TEXT NOT NULL,
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "evento_enmienda" (
    "evento_enmienda_id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "fecha" DATE NOT NULL,
    "cuartel_id" UUID NOT NULL,
    "campania_id" UUID NOT NULL,
    "tipo" TEXT NOT NULL,
    ...
    CONSTRAINT "evento_enmienda_pkey" PRIMARY KEY ("evento_enmienda_id")
);

-- CreateTable
CREATE TABLE "evento_cobertura_erosion" (
    "evento_cobertura_erosion_id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "fecha" DATE NOT NULL,
    "cuartel_id" UUID NOT NULL,
    "campania_id" UUID NOT NULL,
    ...
    CONSTRAINT "evento_cobertura_erosion_pkey" PRIMARY KEY ("evento_cobertura_erosion_id")
);
...
-- CreateTable
CREATE TABLE "tarea_entrada" (
    "entrada_id" UUID NOT NULL DEFAULT gen_random_uuid(),
    ...
    CONSTRAINT "tarea_entrada_pkey" PRIMARY KEY ("entrada_id")
);

-- CreateTable
CREATE TABLE "tarea_asignacion" (
    "tarea_asignacion_id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "tarea_id" UUID NOT NULL,
    "user_id" UUID NOT NULL,
    "estado" "TareaAsignacionEstado" NOT NULL DEFAULT 'pendiente',
    ...
    CONSTRAINT "tarea_asignacion_pkey" PRIMARY KEY ("tarea_asignacion_id")
);
...
-- CreateIndex
CREATE INDEX "idx_enmienda_cuartel_campania_fecha" ON "evento_enmienda"("cuartel_id", "campania_id", "fecha");

-- CreateIndex
CREATE INDEX "idx_cobertura_cuartel_campania_fecha" ON "evento_cobertura_erosion"("cuartel_id", "campania_id", "fecha");
...
-- CreateIndex
CREATE INDEX "idx_tarea_bodega_estado" ON "tarea"("bodega_id", "estado");

-- CreateIndex
CREATE INDEX "idx_tarea_finca_estado" ON "tarea"("finca_id", "estado");

-- CreateIndex
CREATE INDEX "idx_tarea_proceso" ON "tarea"("proceso_id");

-- CreateIndex
CREATE INDEX "idx_tarea_created_by" ON "tarea"("created_by");

-- CreateIndex
CREATE INDEX "idx_tarea_entrada_tarea" ON "tarea_entrada"("tarea_id");

-- CreateIndex
CREATE INDEX "idx_tarea_asignacion_user_estado" ON "tarea_asignacion"("user_id", "estado");

-- CreateIndex
CREATE UNIQUE INDEX "uq_tarea_asignacion_unica" ON "tarea_asignacion"("tarea_id", "user_id");
...
-- CreateIndex
CREATE INDEX "idx_bot_action_tarea_asignacion" ON "bot_action_log"("tarea_asignacion_id");
...
-- AddForeignKey
ALTER TABLE "capacitacion_asistente" ADD CONSTRAINT "capacitacion_asistente_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "app_user"("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_accidente" ADD CONSTRAINT "evento_accidente_accidentado_user_id_fkey" FOREIGN KEY ("accidentado_user_id") REFERENCES "app_user"("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_aplicacion_fitosanitaria" ADD CONSTRAINT "evento_aplicacion_fitosanitaria_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_canopia" ADD CONSTRAINT "evento_canopia_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_capacitacion" ADD CONSTRAINT "evento_capacitacion_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_cosecha" ADD CONSTRAINT "evento_cosecha_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_entrega_epp" ADD CONSTRAINT "evento_entrega_epp_receptor_user_id_fkey" FOREIGN KEY ("receptor_user_id") REFERENCES "app_user"("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_fenologia" ADD CONSTRAINT "evento_fenologia_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_fertilizacion" ADD CONSTRAINT "evento_fertilizacion_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_labor_suelo" ADD CONSTRAINT "evento_labor_suelo_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_limpieza_cosecha" ADD CONSTRAINT "evento_limpieza_cosecha_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_mantenimiento" ADD CONSTRAINT "evento_mantenimiento_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_monitoreo_enfermedad" ADD CONSTRAINT "evento_monitoreo_enfermedad_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_monitoreo_plaga" ADD CONSTRAINT "evento_monitoreo_plaga_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_no_conforme" ADD CONSTRAINT "evento_no_conforme_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_reclamo" ADD CONSTRAINT "evento_reclamo_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_residuo" ADD CONSTRAINT "evento_residuo_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_riego" ADD CONSTRAINT "evento_riego_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_sanitizacion_banos" ADD CONSTRAINT "evento_sanitizacion_banos_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "evento_enmienda" ADD CONSTRAINT "evento_enmienda_campania_id_fkey" FOREIGN KEY ("campania_id") REFERENCES "campania"("campania_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "evento_enmienda" ADD CONSTRAINT "evento_enmienda_cuartel_id_fkey" FOREIGN KEY ("cuartel_id") REFERENCES "cuartel"("cuartel_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "evento_enmienda" ADD CONSTRAINT "evento_enmienda_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "evento_cobertura_erosion" ADD CONSTRAINT "evento_cobertura_erosion_campania_id_fkey" FOREIGN KEY ("campania_id") REFERENCES "campania"("campania_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "evento_cobertura_erosion" ADD CONSTRAINT "evento_cobertura_erosion_cuartel_id_fkey" FOREIGN KEY ("cuartel_id") REFERENCES "cuartel"("cuartel_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "evento_cobertura_erosion" ADD CONSTRAINT "evento_cobertura_erosion_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "evento_sobrante_lavado" ADD CONSTRAINT "evento_sobrante_lavado_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "app_user"("user_id") ON DELETE SET NULL ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "tarea" ADD CONSTRAINT "tarea_bodega_id_fkey" FOREIGN KEY ("bodega_id") REFERENCES "bodega"("bodega_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea" ADD CONSTRAINT "tarea_finca_id_fkey" FOREIGN KEY ("finca_id") REFERENCES "finca"("finca_id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea" ADD CONSTRAINT "tarea_cuartel_id_fkey" FOREIGN KEY ("cuartel_id") REFERENCES "cuartel"("cuartel_id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea" ADD CONSTRAINT "tarea_proceso_id_fkey" FOREIGN KEY ("proceso_id") REFERENCES "protocolo_proceso"("proceso_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea" ADD CONSTRAINT "tarea_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "app_user"("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea_entrada" ADD CONSTRAINT "tarea_entrada_tarea_id_fkey" FOREIGN KEY ("tarea_id") REFERENCES "tarea"("tarea_id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea_entrada" ADD CONSTRAINT "tarea_entrada_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "app_user"("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea_asignacion" ADD CONSTRAINT "tarea_asignacion_tarea_id_fkey" FOREIGN KEY ("tarea_id") REFERENCES "tarea"("tarea_id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tarea_asignacion" ADD CONSTRAINT "tarea_asignacion_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "app_user"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "bot_action_log" ADD CONSTRAINT "bot_action_log_tarea_asignacion_id_fkey" FOREIGN KEY ("tarea_asignacion_id") REFERENCES "tarea_asignacion"("tarea_asignacion_id") ON DELETE SET NULL ON UPDATE NO ACTION;
